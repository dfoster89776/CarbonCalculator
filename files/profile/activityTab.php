<?php
	...
	$activity = $carbon->getUserActivity($profile, 0);
	
	$count = 1;
				
	if ($activity == null){
		
		echo("<h3 style='text-align: center'> No activity to display. </h3>");
		
	}else{
							
		echo("<ul class='media-list col-md-offset-2 col-md-6' id='activityList'>");
