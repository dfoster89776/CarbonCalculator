<?php
	...
	@$data['percentageEnergy'] = round(($data['currentEnergy']/$data['previousEnergy'])*100);
	...
	@$data['percentageTransport'] =  round(($data['currentTransport']/$data['previousTransport'])*100);
	@$data['percentageTotal'] = round(($data['currentTotal']/$data['previousTotal'])*100);
?>
